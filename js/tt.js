...
if (typeof Bnet == 'undefined')
    var Bnet = {};
if (typeof Bnet.D3 == 'undefined')
    Bnet.D3 = {};

if (typeof Bnet.D3.Tooltips == 'undefined')
    Bnet.D3.Tooltips = new function () { // Reminder: Keep in sync with the equivalent code in d3.js
...
//            $.getStyle(cssUrl + 'tooltips.css'); //don't annoy me!
            if ($.Browser.ie6) {
        ...
        function parseUrl(link, params) {
            ...
            if(link.getAttribute('data-d3tooltip') !== null) {
                var rest = link.getAttribute('data-d3tooltip');
            } else {
                var rest = RegExp.$3;
            }
        ...
        var Tooltip = new function () {
            ...
            function show(node, html) {
                ...
                reveal(20+viewport.l, 20+viewport.t);
//                reveal(x, y);
            }
